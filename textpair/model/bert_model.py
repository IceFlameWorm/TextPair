...
class BertModel(BaseModel):
    ...
    def tranform(self, vec1, vec2):
        ...
        with torch.no_grad():
            encoded_layers1, _ = self.bert_model(tokens_tensor1, segments_tensors1)
            encoded_layers2, _ = self.bert_model(tokens_tensor2, segments_tensors2)

        # 取最后一层的[CLS]的向量作为句子的向量
        cls1 = encoded_layers1.numpy()[:,0,:]
        cls2 = encoded_layers2.numpy()[:,0,:]
